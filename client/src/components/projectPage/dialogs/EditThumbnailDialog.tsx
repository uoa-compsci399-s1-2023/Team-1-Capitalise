...
import { uploadThumbnail } from '../../../api/projectThumbnailApi';
...
export default function EditThumbnailDialog({ isDialogOpen, setIsDialogOpen, isLoading, setIsLoading }: EditThumbnailDialogProps) {
  ...
  const handleSave = () => {
    if (value) {
      ...
      uploadThumbnail(project._id, formData)
        .then((resp) => {
