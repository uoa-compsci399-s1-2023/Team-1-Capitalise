...
const About = () => {
  ...
  return (
    <div className="About">
      ...
      <Box mb={6}>
        <h1>
          Example 1: Something everyone sees. But only logged in users can use.
        </h1>
      ...
      <Box mb={6}>
        <h1>
          Example 3: Something only visitors, and graduates can see but only
          graduates can use
        </h1>
        {auth.isAllowed(["visitor", "graduate"]) && (
          <input
            type="button"
